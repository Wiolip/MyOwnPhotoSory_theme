...
function mopsload_css(){
    ...
    wp_enqueue_style('googlefonts', "https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&family=Merriweather:wght@400;700&family=Rowdies:wght@300;400&display=swap", array(), false, 'all' );
